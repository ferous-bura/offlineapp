from basesdk.resource import List, Find, Create, Delete, Update, Replace
...
class WebProfile(Create, Find, List, Delete, Update, Replace):
    ...
    to the SuperApp payment. API docs at
    https://developer.superapp.com/docs/api/#payment-experience
