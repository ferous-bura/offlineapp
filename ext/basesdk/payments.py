...
from basesdk.api import default as default_api
...
class Payment(List, Find, Create, Post, Replace):
    ...
    """
    path = "card-form/" # "v1/payments/payment"
    ...
    def execute(self, attributes):
        try:
            response = self.post('execute', attributes, self)
...
class BillingPlan(List, Create, Find, Replace):
    ...
    https://developer.superapp.com/webapps/developer/help/docs/integration/direct/create-billing-plan/
...
class BillingAgreement(Create, Find, Replace, Post):
    ...
    https://developer.superapp.com/webapps/developer/help/docs/integration/direct/create-billing-agreement/
...
class Authorization(Find, Post):
    ...
    Helpful links::
    https://developer.superapp.com/help/docs/api/#authorizations
    https://developer.superapp.com/help/docs/integration/direct/capture-payment/#authorize-the-payment
